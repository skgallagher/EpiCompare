...
sim50 <- EpiCompare::simulate_SIR_agents(n_sims = n_sims,
...
b <- ggplot() +
  geom_prediction_band(data = df_group, 
                       ...
                       conf_level = .4, pb_type = "delta_ball") +
  geom_path(data = df_single, aes(x = S, y = I, z = R), color = "blue") +
  coord_tern()
```
...
What about a less strigent ruling? 
...
sim50_2 <- EpiCompare::simulate_SIR_agents(n_sims = 50,
                                       n_time_steps = 100,
                                       beta = beta, gamma = gamma,
                                       init_SIR = c(950, 50, 0))
