...
I've hidden the creation of a python version of `EpiCompare::local_deistance_depth_function` in this document, but it's code the same way - just a little faster in `python` than `R`.
