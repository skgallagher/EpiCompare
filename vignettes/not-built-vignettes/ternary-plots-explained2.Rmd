...
```{r x-stretch, fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval = .005, echo = F, eval = F}
...
```{r all-stretch, fig.show='animate', ffmpeg.format='gif', dev='jpeg', interval = .005, echo = F,  fig.width= 7, eval = F}
