...
Because ternary plots aren't *that* common in epidemogolgy (yet `r emo::ji("wink")`), so we thought it would be useful to introduced them in more detail here, so that users can feel more comfortable interpreting them.
