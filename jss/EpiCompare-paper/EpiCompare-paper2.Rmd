...
EpiCompare emphasizes the value of analyzing epidemics in a \textit{time-invariant} way -  approaches that remove some or all of the impact of start/end times and recording time scales when preforming the analysis. In this section we will highlight weaknesses of time-\textit{de}pendent analysis and define the mathematical underpinning of the time-invariant approach we take. 
To accomplish this goal we will first demonstrate the inability of time-dependent tools to well quantify a classic epidemic parameter, the reproduction number $R_0$. 
Then we will motivate new time-invariant approaches for more complex situations where $R_0$ doesn’t capture the complexities of outbreaks. This will lead us to our final subsection that defines ways to view epidemics in a time-invariant lense and discusses natural properties of these representations that allow for clearer ways to compare models and epidemics.
