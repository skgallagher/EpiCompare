...
and (2) by treating full epidemics as filamental
trajectories\sout{ and not points produced by functions of time}
\textcolor{orange}{(this concept will be explained in  explained in Section \ref{sec:r0})}.
...
\textcolor{orange}{time-invariant analysis} focuses on
\sout{the overall \textcolor{orange}{shape and direction, a filamental trajctory,} \sout{trajectory of }an epidemic.  \textcolor{orange}{These filamental trajectories,  in turn,} }
\textcolor{orange}{filamental trajectories, which emphasize the number of lives affected.}
