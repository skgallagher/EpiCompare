...
to provide aggregation at a subpopulation
...
simplex representation of these epidemics emphasizes a time-invariant
...
and/or simulation. In this step and the next step (post-processing), we
...
statistics, plots, and tables. In \pkg{EpiCompare}, we provide (1)
...
provide the function, \code{filament_compression()}, to transform
...
simulations to one another. In \pkg{EpiCompare} we provide a set of
