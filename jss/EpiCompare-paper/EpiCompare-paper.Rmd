...
\shannon{[Shannon says: Here Ben talks about filament compression and tidy\_dist mats, etc.]} \ben{[Ben says: not currently thinking about including tidy\_dist stuff - will need to think about this as it is including in the pipeline 2 image...]} \footnote{\ben{[Ben says: are these comments still relevant?]}}
